...
public class WincoinCalculator implements Runnable {
    ...
    /**
     * calculate the WNC generated by every post every iterationsInterleave ms
     */
    @Override
    public void run() {
        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            // hashMap containing total earnings of every curator
            ...
            for (Post post : posts.values()) {
                ...
                if (wincoin > 0) {
                    // split WNC between creator and curator
